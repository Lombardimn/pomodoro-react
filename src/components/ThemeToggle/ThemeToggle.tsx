...
const ThemeToggle = ( {id}: { id?: string }) => {
  ...
  return (
    <button id={id ? id : "scheme"} onClick={handleTheme} aria-pressed='false' className="flex justify-between items-center border-2 rounded-full p-0 cursor-pointer dark:bg-background-light/15 bg-background-dark/15 hover:border-hover-light dark:hover:border-hover-dark">
